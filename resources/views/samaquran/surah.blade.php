   ...
   -->
    ...
    <div class="container header">
        <div class="row">
            ...
            <div class="col-md-6">
                <img src="{{ asset('samaquran/image/quran.png') }}" alt="Gambar" class="img-fluid">
            </div>
        </div>
    </div>
    <!-- Header -->
    ...
    <div class="quran">
        ...
        <div class="container cari">
            <div class="input-group mb-3">
                ...
                <button class="btn btn-outline-secondary btn-cari" type="button" id="button-addon2"><img src="{{ asset('samaquran/image/ant-design_search-outlined.png') }}" alt=""></button>
            </div>
        </div>
        ...
        <div class="container list">
            ...
            @foreach ($data as $datas)
                <div class="col-md-4 mb-3">
                    <div class="card">
                        <a href="{{ route('samaquran.detail',[$datas->nomor]) }}" style="text-decoration:none;">
                            <div class="card-body">
                                <div class="lingkar">
                                    {{ $datas->nomor}}
                                </div>
                                <div class="nama">
                                    <div>
                                        <p class="surah">{{ $datas->nama_latin}}</p>
                                        <p class="arti">{{ $datas->arti}}</p>
                                    </div>
                                </div> 
                                <p class="ayat">{{ $datas->jumlah_ayat}} Ayat</p> 
                            </div>
                        </a>
                    </div>
                </div>
